...
namespace PacSharpApp.Graphics
{
    static class GraphicsConstants
    {
        ...
        internal static readonly Size SpriteSize = new Size(SpriteWidth, GraphicsConstants.SpriteWidth);
        internal static readonly Size TileSize = new Size(TileWidth, GraphicsConstants.TileWidth);
    }
    ...
    class GraphicsHandler : IDisposable
    {
        ...
        internal GraphicsHandler(IGameUI ui, Control gameArea)
        {
            ...
            screenImage = new Bitmap(GraphicsConstants.GridWidth * GraphicsConstants.TileWidth, GraphicsConstants.GridHeight * GraphicsConstants.TileWidth);
            tileImage = new Bitmap(GraphicsConstants.GridWidth * GraphicsConstants.TileWidth, GraphicsConstants.GridHeight * GraphicsConstants.TileWidth);
        }
        ...
        internal static Rectangle GetGraphicLocation(GraphicsID id)
        {
            ...
            switch (id)
            {
                ...
                case GraphicsID.TileGhostBottomRight:
                    ...
                    width = GraphicsConstants.TileWidth;
                    break;
                case GraphicsID.TileMazeGateLeft:
                ...
                case GraphicsID.SpriteCherry:
                    location = new Point(0, 0);
                    width = GraphicsConstants.SpriteWidth;
                    break;
